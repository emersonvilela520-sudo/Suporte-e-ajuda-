    ...
    <div class="grid">
      <main>
        <article class="card section" id="introducao">
          ...
          <img src="https://i.postimg.cc/ppzqfQNf/IMG-20250912-WA0038.jpg" alt="Protótipo" onclick="openImage(this.src)"/>
        </article>
        ...
        <article class="card section" id="desenvolvimento">
          ...
          <section id="estrutura">
            ...
            <div class="flex-row">
              ...
              <img src="https://i.postimg.cc/nCB04K8G/IMG-20250912-WA0040.jpg" alt="Estrutura Mecânica 1" onclick="openImage(this.src)"/>
              <img src="https://i.postimg.cc/MvVd70kt/IMG-20250912-WA0069.jpg" alt="Estrutura Mecânica 2" onclick="openImage(this.src)"/>
            </div>
          </section>
          ...
          <section id="integracao">
            ...
            <img src="https://i.postimg.cc/xcMtvGrP/IMG-20250912-WA0041.jpg" alt="Integração Eletrônica" onclick="openImage(this.src)"/>
          </section>
          ...
          <section id="diagrama">
            ...
            <div class="flex-col">
              ...
              <img src="https://i.postimg.cc/zVK0CwmS/Screenshot-20250924-225609-721.png" alt="Diagrama 1" onclick="openImage(this.src)"/>
              <img src="https://i.postimg.cc/w7L0X